...
var app = function app() {
	...
	var HomeView = React.createClass({
		...
		render: function render() {
			return React.createElement('div', { id: 'wrapper' }, React.createElement(Header, null), React.createElement(Content, null), React.createElement(Sticky, null));
		}
	});
	...
	var Header = React.createClass({
		...
		render: function render() {
			return React.createElement('div', { id: 'header' }, React.createElement('img', { id: 'hero-img', src: 'http://magentanova.github.io/html-intro-1/images/houston.jpg' }), React.createElement('img', { id: 'logo', src: 'http://magentanova.github.io/html-intro-1/images/ironyardlogo.png' }));
		}
	});
	...
	var Content = React.createClass({
		...
		render: function render() {
			return React.createElement('div', { id: 'content' }, React.createElement('div', { id: 'leftCol' }, React.createElement('h3', null, ' The Iron Yard | Houston '), React.createElement('p', null, ' Happenings and updates from The Iron Yard in Houston, TX '), React.createElement('hr', null), React.createElement('p', null, ' SEARCH '), React.createElement('input', { type: 'text', name: 'search', placeholder: 'Search Keywords' })), React.createElement('div', { id: 'rightCol' }, React.createElement('h2', null, ' September 22 Starts a New Class of The Iron Yard Houston Students '), React.createElement('p', null, ' By Brian Dorton, Campus Director at The Iron Yard Houston '), React.createElement('img', { src: 'http://magentanova.github.io/html-intro-1/images/classroom.jpg' }), React.createElement('p', null, 'Lorem ipsum dolor sit amet, consectetur adipisicing elit. Quas reiciendis natus architecto nostrum aperiam repudiandae possimus a delectus expedita atque commodi aliquam corrupti voluptas nemo voluptate vero minus, voluptatibus fugiat.')));
		}
	});
	...
	var Sticky = React.createClass({
		...
		render: function render() {
			return React.createElement('div', { id: 'sticky-box' }, React.createElement('div', { id: 'sticky-title' }, React.createElement('strong', null, ' Never miss a post!'), ' ', React.createElement('hr', null)), React.createElement('div', { id: 'twitter' }, React.createElement('div', { id: 'stick-logo' }, React.createElement('img', { src: 'http://magentanova.github.io/html-intro-1/images/ironyardlogo.png' })), React.createElement('div', { id: 'twitter-account' }, React.createElement('p', null, React.createElement('strong', null, 'tiyhouston'), React.createElement('br', null), React.createElement('span', { id: 'sticky-name' }, 'The Iron Yard | Houston '))), React.createElement('div', { id: 'twitter-button' }, React.createElement('a', { href: 'https://twitter.com/TheIronYard', 'class': 'twitter-follow-button', 'data-show-count': 'false', 'data-show-screen-name': 'false' }, 'Follow @TheIronYard'))));
		}
	});
